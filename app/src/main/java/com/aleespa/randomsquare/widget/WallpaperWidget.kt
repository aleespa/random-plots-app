...
class WallpaperWidget : GlanceAppWidget() {
    ...
    private fun WidgetContent() {
        ...
        val defaultNumbers = List(42) {
            (1..5).map { _ -> charPool.random() }.joinToString("")
        }.joinToString(",")
        ...
        Box(
            modifier = GlanceModifier
                ...
                .cornerRadius(24.dp)
                .padding(6.dp)
                .clickable(actionRunCallback<WallpaperWidgetActionCallback>()),
            ...
            // Overlay refresh button on top-right
            Box(
                modifier = GlanceModifier.fillMaxSize(),
                contentAlignment = Alignment.TopEnd
            ) {
                Image(
                    provider = ImageProvider(com.aleespa.randomsquare.R.drawable.ic_refresh),
